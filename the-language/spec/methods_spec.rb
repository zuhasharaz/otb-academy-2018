...
RSpec.describe "methods in ruby" do
  ...
  it "is not possible to call methods with the wrong number of arguments" do
    ...
    expect { a_global_method(1,2,3) }.to raise_error( ArgumentError, /wrong number of arguments \(given 3, expected 2\)/ ) # HINT: Fill in the error and part of the message
  end
  ...
  it "is possible to create methods with a variable number of args" do
