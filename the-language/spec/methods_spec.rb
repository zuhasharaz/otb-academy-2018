...
RSpec.describe "methods in ruby" do
  ...
  context "methods on objects" do
    ...
    it "raises an error when calling a private method" do
      ...
      expect { an_object.the_private_method }.to raise_error( NoMethodError, /private method `the_private_method'/  )
    end
    ...
    it "raises an error if a private method has an explicit receiver" do
      expect { an_object.calls_the_private_method_on_self }.to raise_error(NameError, /private method `the_private_method' / )
    end
